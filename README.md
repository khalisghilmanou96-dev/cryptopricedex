...
## Correction GitHub Pages — logos intégrés
Les logos principaux sont désormais embarqués directement dans `script.js` en SVG Data URI. Les cartes et la modale ne dépendent donc plus de chemins `assets/` ni d’un CDN pour les logos affichés.
